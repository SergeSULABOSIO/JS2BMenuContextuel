...
import BEAN_MenuContextuel.RubriqueMenu;
import BEAN_MenuContextuel.RubriqueSeparateur;
...
public class Principal extends javax.swing.JFrame {
    ...
    public void construireMenu(){
        ...
        menuCalculsPression.Ajouter(menuCalculsPressionAltitude);
        ...
        menuCalculsPressionPk.Ajouter(menuCalculsPressionPKStationRelais);
        
        RubriqueMenu menuCalculsDebitMoyen = new RubriqueMenu("Débit Moyen");
        RubriqueMenu menuCalculsFouite = new RubriqueMenu("Fouite");
        
        menuCalculs.Ajouter(menuCalculsPression);
        menuCalculs.Ajouter(menuCalculsDebitMoyen);
    ...
    private void scrollMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_scrollMenuMouseClicked
        ...
        if(evt.getButton() == MouseEvent.BUTTON3){
            menuContextuel.afficher(scrollMenu, evt.getX(), evt.getY());
        }
